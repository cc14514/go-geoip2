...
type Metadata struct {
	BinaryFormatMajorVersion uint              `driver:"binary_format_major_version"`
	BinaryFormatMinorVersion uint              `driver:"binary_format_minor_version"`
	BuildEpoch               uint              `driver:"build_epoch"`
	DatabaseType             string            `driver:"database_type"`
	Description              map[string]string `driver:"description"`
	IPVersion                uint              `driver:"ip_version"`
	Languages                []string          `driver:"languages"`
	NodeCount                uint              `driver:"node_count"`
	RecordSize               uint              `driver:"record_size"`
}
